...
void check_undef_func() {
    ...
    for (i = 0; i < NR_SYMBOL_TABLE; ++ i) {
        hash_node *p_node = symbol_table[i].next;
        while (p_node) {
...
void handle_ExtDef(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_Def(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_DecList(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_Dec(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
    children[0]->attr.is_in_struct = p_node->attr.is_in_struct;
    children[0]->attr.inh_type = p_node->attr.inh_type;
    sdt(children[0]);
    if (p_node->attr.is_in_struct)
...
void handle_Exp(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_Args(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
    sdt(children[0]);
...
void handle_Specifier(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_StructSpecifier(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_ExtDecList(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_VarDec(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_FunDec(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_VarList(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_ParamDec(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_CompSt(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_StmtList(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_DefList(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
...
void handle_Stmt(int child_num, syntax_tree_node *p_node, syntax_tree_node **children) {
